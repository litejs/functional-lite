...
compile-events:
	...
	@curl -s \
		    --data-urlencode 'output_info=compiled_code' \
				...
				'http://closure-compiler.appspot.com/compile' > util/events-min.js
...
compile-iter:
	...
	@curl -s \
		    --data-urlencode 'output_info=compiled_code' \
				...
				'http://closure-compiler.appspot.com/compile' > util/iter-min.js
...
compile-lazy:
	...
	@curl -s \
		    --data-urlencode 'output_info=compiled_code' \
				...
				'http://closure-compiler.appspot.com/compile' > util/lazy-min.js
